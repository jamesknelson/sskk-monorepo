...
export function consolidateListNodes(tr: Transaction): Transaction {
  ...
  let prevJointInfo: JointInfo | null = null
...
function linkOrderedListCounters(tr: Transaction): Transaction {
  ...
  let listsBefore = null as
    | null
    | { parentNode: Node; indent: number; node: Node }[]
...
function traverseDocAndFindJointInfo(
  ...
  let prevNode = null as Node | null
  let jointInfo = null as JointInfo | null
