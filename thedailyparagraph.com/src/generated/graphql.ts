...
export type DashboardPostListQuery = (
  ...
  & { posts: Array<(
    ...
    & { versions: Array<(
      { __typename?: 'post_versions' }
      & Pick<Post_Versions, 'id' | 'title' | 'editor_state' | 'locked_for_publication' | 'updated_at'>
    )> }
  )> }
);
...
export type DashboardPostEditorQuery = (
  ...
  & { post?: Maybe<(
    ...
    & { versions: Array<(
      { __typename?: 'post_versions' }
      & Pick<Post_Versions, 'id' | 'title' | 'locked_for_publication' | 'updated_at' | 'editor_state' | 'slug'>
    )> }
  )> }
);
...
export type CreatePostMutation = (
  ...
  & { insert_posts_one?: Maybe<(
    ...
    & { versions: Array<(
      { __typename?: 'post_versions' }
      & Pick<Post_Versions, 'editor_state' | 'id' | 'locked_for_publication' | 'slug' | 'title'>
    )> }
  )> }
);
...
export type SavePostDraftMutation = (
  ...
  & { insert_post_versions?: Maybe<(
    ...
    & { returning: Array<(
      { __typename?: 'post_versions' }
      & Pick<Post_Versions, 'id' | 'locked_for_publication' | 'editor_state' | 'slug' | 'title' | 'updated_at' | 'created_at'>
    )> }
  )> }
);
