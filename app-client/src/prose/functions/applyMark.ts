...
import { SelectionRange, TextSelection, Transaction } from 'prosemirror-state'

function markApplies(
  doc: ProsemirrorNode<any>,
  ranges: SelectionRange<any>[],
  type: MarkType,
) {
...
export function applyMark(
  ...
  const { empty, $cursor, ranges } = tr.selection as TextSelection<any>
